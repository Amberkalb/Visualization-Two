...
```
###### Figure two: The red dots on the map depict the rate of immigration for each region of Netherlands between 2010 and 2012.

####Findings
Rather than finding a high rate of change for immigration in Limburg, the rate of immigration into the region is moderate with respect to fellow regions. Curiously, other regions, such as Groningen, show far less regional voter support for the PVV, while having relatively high rates of change of immigration. 
